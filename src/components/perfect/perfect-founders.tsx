...
export default function PerfectFounders() {
  ...
  return (
    <div className="bg-gray-100 grid grid-cols-1 gap-4 items-center justify-items-center m-8 rounded-xl">
      <div className="relative mt-24 mb-0 max-w-sm mx-auto">
        <div className="rounded overflow-hidden shadow-md bg-white">
          ...
          <div className="px-8 pb-8 mt-16">
            <h1 className="font-bold text-3xl text-center mb-1">{t("name")}</h1>
